...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page" style="color: #3d3a3a;">Editar Cliente</li>
    </ol>
</nav>
    ...
    <form action="{{ route('clientes.update', $cliente->cedula) }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="cedula" id="cedula" class="form-control" value="{{ $cliente->cedula }}" readonly>
            </div>
        </div>

        <div class="mb-3">
            <label for="email" class="form-label">Correo Electrónico:</label>
            <input type="email" name="correo" id="email" class="form-control" value="{{ $cliente->correo }}" required>
        </div>
